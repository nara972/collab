...
import com.nara.collaboration.dto.MemberForm;
...
import com.nara.collaboration.validator.ProjectBuildValidator;
...
public class ProjectController {
    ...
    public String settings(@PathVariable String email,@PathVariable String title,Model model,
        ...
        List<Invitation> sentInvitations=notificationService.getSentInviataions(project.getId());
